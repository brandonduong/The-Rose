...
import static theRose.characters.TheRose.Enums.COLOR_GRAY;

//Wiki-page https://github.com/daviscook477/BaseMod/wiki/Custom-Characters
//and https://github.com/daviscook477/BaseMod/wiki/Migrating-to-5.0
//All text (starting description and loadout, anything labeled TEXT[]) can be found in DefaultMod-character-Strings.json in the resources

public class TheRose extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_ROSE;
    ...
    private static final String ID = makeID("RoseCharacter");
    ...
    public TheRose(String name, PlayerClass setClass) {
        super(name, setClass, null,null, null,
                new SpriterAnimation(
                        "theRoseResources/images/char/defaultCharacter/Spriter/theDefaultAnimation.scml"));
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(NinjaRose.ID);
        retVal.add(BRose.ID);
        retVal.add(BigBlubber.ID);
        retVal.add(FoodComa.ID);
    ...
    public Color getCardTrailColor() {
        return theRose.ModInitializer.DEFAULT_GRAY;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheRose(name, chosenClass);
    }
